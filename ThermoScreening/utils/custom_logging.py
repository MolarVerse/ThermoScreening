...
that are used in the THermoScreening package.
"""
...
from ThermoScreening.config import log_file_name, use_log_file
from ThermoScreening.utils import print_header
from ThermoScreening.exceptions import ThermoScreeningException
...
def setup_logger(logger: logging.Logger) -> logging.Logger:
    ...
    of the ThermoScreening package. It automatically adds a stream handler to the logger
...
class CustomLogger(logging.Logger):
    ...
    default logger class for the ThermoScreening package. It re-implements
    ...
    def _log(self,   # pylint: disable=arguments-differ
        ...
        if level in [logging.CRITICAL, logging.ERROR]:
            ...
            def exception_hook(exc_type, exc_value, exc_traceback):
                ...
                """
                if exc_type != ThermoScreeningException:
...
class CustomFormatter(logging.Formatter):
    ...
    the log messages of the ThermoScreening package. It re-implements the 
